...
def test_over_age_150():
    ...
    sprint3.anomaly_array = []
    sprint3.is_age_legal()
    
    return sprint3.anomaly_array==['ANOMALY: INDIVIDUAL: US07: @I1@: More than 150 years old - Birth Date 1860-6-5',
...
def test_dates_error(date,ddate,bdate,fdate):
 ...
 '@I2@': {'INDI': '@I2@',
  ...
  'ALIVE': False}}
    ...
    return sprint3.anomaly_array==[f'ERROR: FAMILY: US01: @F8@: Family has marrige date {date} later than today',
...
def test_birth_before_marraige_do_nothing():
    ...
    sprint3.is_birth_before_marraige()
...
def test_birth_after_marraige_appended_to_error():
    ...
    assert sprint3.anomaly_array[0] == "ERROR: INDIVIDUAL: US02: @I1@: Person has marriage date 1968-6-4 before birth date 1970-11-8"
    return True
...
def test_check_positive_for_bigamy():
    ...
    sprint3.anomaly_array = []
    sprint3.individuals = individuals
    sprint3.check_for_bigamy()
    
    assert sprint3.anomaly_array[0] == 'ANOMALY: INDIVIDUAL: US11: 10: @I1@: Performing bigamy'
...
def test_check_positive_parent_child_marriage():
    ...
    sprint3.anomaly_array = []
    sprint3.individuals = individuals
    sprint3.check_parent_child_marriage()
    
    assert sprint3.anomaly_array[0] == "ANOMALY: INDIVIDUAL: US17: 11: @I2@: Individual married to child @I3@"
...
def test_list_deceased_individuals_success(mock_printTable):
    ...
    sprint3.individuals = current_dic
    sprint3.listDeceased()
...
def test_unique_family_name_and_birth_pass():
    ...
    sprint3.family_dic = family_dic
    sprint3.anomaly_array = []
    sprint3.unique_family_name_and_birth()

    return sprint3.anomaly_array==['ANOMALY: INDIVIDUAL: US25: @I13@: @I7@: Individuals share the same name Beth /Venzon/ and birth date 1973-7-8 from family @F1@']
...
def test_unique_name_and_birth_pass(year):
    ...
    sprint3.unique_name_and_birth()

    return sprint3.anomaly_array == [
...
def test_birth_before_marriage_fail():
    ...
    sprint3.family_dic = family_dic
    sprint3.anomaly_array = []
    sprint3.birth_before_marriage()

    return sprint3.anomaly_array == ['ANOMALY: INDIVIDUAL: US08: @I7@: Child was born at 1973-7-6 before marriage of parents 1973-7-7',
...
def test_birth_before_death_fail():
    ...
    sprint3.family_dic = family_dic
    sprint3.error_array = []
    sprint3.birth_before_death()

    return sprint3.error_array == ['ERROR: INDIVIDUAL: US09: @I7@: Child was born at 1988-1-9 after death of mother 1987-12-6', 
...
def aunts_and_uncles_success():
    ...
    assert sprint3.is_uncle_aunt_marriage_legal() == True
    return True
...
def aunts_and_uncles_error():
    ...
    assert sprint3.is_uncle_aunt_marriage_legal() == False
    return True
...
def test_multiple_birth_pass():
    ...
    sprint3.family_dic = family_dic
    sprint3.anomaly_array = []
    sprint3.multiple_birth()

    return sprint3.anomaly_array==['ANOMALY: FAMILY: US32: 365: The two or more individuals were born at the same time in a family @F3@']
    return True
    
def input_line_numbers():
    sprint3.input_file = "./test.ged"
    document = sprint3.read_in("./test.ged")
...
def test_is_marriage_after_divorce():
    ...
    sprint3.is_marriage_after_divorce()
...
def test_is_marriage_after_divorce_error():
    ...
    return sprint3.anomaly_array[0] == "ANOMALY: INDIVIDUAL: US04: 438: @I1@: Marriage Before Divorce - Marriage Date 1970-7-7 - Divorce Date 1969-7-7"
...
def test_is_marriage_after_death():
    ...
    sprint3.is_marriage_after_death()
...
def test_is_marriage_after_death_error():
    ...
    sprint3.is_marriage_after_death()
    assert sprint3.anomaly_array[0] == "ANOMALY: INDIVIDUAL: US05: 438: @I1@: Marriage Before Death - Marriage Date 1970-7-7 - Death Date 1969-6-20"
    return True
...
def test_large_age_diff_pass():
    ...
    sprint3.family_dic = family_dic
    sprint3.anomaly_array = []
    sprint3.large_age_diff()

    return sprint3.anomaly_array==['ANOMALY: FAMILY: US34: 388: Family with unique id: @F4@ has a large spouse age difference']
    return True
...
def test_parents_not_too_old_fail():
    ...
    sprint3.check_parents_not_too_old()

    return sprint3.error_array == ['ERROR: INDIVIDUAL: US12: 67: @F1@: Father is 100 older than the child @I7@.',
...
def test_check_sibling_spacing_1_month_apart():
    ...
    sprint3.check_sibling_spacing()
    
    assert sprint3.error_array == result_array
    return True
...
def test_check_sibling_spacing_siblings_1_day_apart():
    ...
    assert len(sprint3.error_array) == 0
